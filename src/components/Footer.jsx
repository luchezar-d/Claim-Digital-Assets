        ...
        <div className="pt-6 border-t border-gray-800/30">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="#terms" className="font-body text-gray-500 hover:text-gray-300 transition-colors duration-200">
                Terms of Service
              </a>
              <a href="#disclaimer" className="font-body text-gray-500 hover:text-gray-300 transition-colors duration-200">
                Disclaimer
              </a>
            </div>
          </div>
