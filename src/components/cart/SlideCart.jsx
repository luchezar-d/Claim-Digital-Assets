  ...
  return (
    <>
      ...
      <div className="fixed inset-y-0 right-0 z-50 flex">
        <div
          className={`
            bg-gradient-to-b from-[#0e0e15] to-[#0b0b10] border-l border-purple-500/30 shadow-2xl shadow-purple-500/20 w-full md:w-[420px] flex flex-col
            transform transition-transform duration-300 ease-out
            ${open ? 'translate-x-0' : 'translate-x-full'}
          `}
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-purple-500/30 bg-gradient-to-r from-purple-900/20 to-pink-900/20">
          ...
          {/* Footer */}
          {items.length > 0 && (
            <div className="border-t border-purple-500/30 p-4 space-y-4 bg-gradient-to-r from-purple-900/10 to-pink-900/10">
              {/* Subtotal */}
